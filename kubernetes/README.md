Instalação persistente do CephFS do PostgreSQL e Alfresco em Kubernetes
===


Este exemplo descreve como executar uma instalação persistente de [Alfresco Community Edition](https://community.alfresco.com/) e [PostgreSQL](https://www.postgresql.org/) com Kubernetes. Usaremos a iamgem oficial [postgres](https://hub.docker.com/_/postgres/) e [Alfresco](https://hub.docker.com/r/fjudith/alfresco/) [Docker](https://www.docker.com) imagens para esta instalação.

O armazenamento será fornecido pela Kubernetes [Ceph Filesystem](https://github.com/ceph/ceph-docker)para trazer tolerância a falhas para os dados persistentes do Pods.
